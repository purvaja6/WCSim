...
//changed from here for solidworks geometry for 48 degree reflector case
void WCSimDetectorConstruction::SetNuPrismShort_mPMTGeometry()
{
	WCDetectorName = "NuPRISMShort_mPMT";
	WCIDCollectionName = WCDetectorName +"-glassFaceWCPMT";
	...
	// Radius of cone at z=reflectorHeight
	id_reflector_height = 8.81*CLHEP::mm;        // for a radius of 7.25mm, for hex: 5.4mm (radius of 6mm)
